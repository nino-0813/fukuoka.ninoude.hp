...
import { CaseStudy, MenuItem, FAQItem, MonitorType, MonitorRequirement } from './types';
import { Sparkles, Activity, Clock, MapPin, Phone, MessageCircle } from 'lucide-react';
...
export const MONITOR_TYPES: MonitorType[] = [
  {
    id: 1,
    title: "部分モニター",
    description: "ホームページ・SNSなどの媒体で、体の部位ごと、または片側だけなどを撮影したお写真を使用させていただくのが部分モニターです。施術前後のお写真は、比較的個人を特定されにくいモニターになります。",
...
export const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    price: "¥88,000〜",
    duration: "全8回",
    description: "徹底的に二の腕のセルライトと脂肪を分解し、形状記憶させる1番人気のコースです。",
    icon: "Activity"
  },
  {
    id: 3,
...
export const FAQS: FAQItem[] = [
  {
    ...
    answer: "個人差はございますが、1回の施術でもサイズダウンを実感される方がほとんどです。根本的な改善には3ヶ月（8回〜）程度の継続をおすすめしています。"
  },
  {
    question: "痛みはありますか？",
    answer: "老廃物が溜まっている箇所は多少の痛みを感じる場合がありますが、お客様の体調や好みに合わせて強さを調整いたしますのでご安心ください。多くの方が途中で眠ってしまうほどのリラックス効果もございます。"
  },
  {
    question: "運動や食事制限は必要ですか？",
    answer: "過度な制限は必要ありませんが、施術効果を高めるための簡単なホームケアや、老廃物を流しやすくする食事のコツなどのアドバイスを行っております。"
  }
];
