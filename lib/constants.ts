...
export const LINE_URL = 'https://lin.ee/DS9UvmW';
...
export const MONITOR_TYPES: MonitorType[] = [
  ...
  {
    id: 2,
    title: '全顔・Instagramモニター',
    description:
      '施術風景やビフォーアフターの様子を動画や写真で撮影し、当サロンのInstagramに公開させていただける方を対象とするのがInstagramモニターです。原則として全顔出しモニターとなります。',
    image: '/images/instagram-monitor.webp',
  },
];
...
export const CASE_STUDIES: CaseStudy[] = [
  {
    id: 1,
    title: '振袖肉スッキリ改善',
    beforeImg: '/images/about/S__59588622_0.webp',
    afterImg: '/images/about/S__59588623_0.webp',
    period: '6ヶ月',
    count: '20回以上',
    description: 'ノースリーブを自信を持って着られるようになりました。',
    body: '今まで来てた服のシルエットが変わり服に余裕が出来た。・20回以上　6ヶ月',
  },
  {
    id: 2,
    title: '肩周りと背中の厚みが解消',
    ...
    body: '肩甲骨の位置が上がり背中は一回り小さく後ろ姿が別人に。',
  },
  {
    id: 3,
    title: '結婚式前の集中ケア',
    beforeImg: '/images/about/S__59891724.webp',
    afterImg: '/images/about/S__59891724.webp',
    period: '1.5ヶ月',
    count: '3回目',
    description: 'ドレス試着の時とは見違えるほど細くなりました！',
    body: '体重比なし。試着の時よりもドレスが映えるお姿に！',
  },
  {
    id: 4,
    title: '二の腕・背中まわりスッキリ',
    beforeImg: '/images/about/S__59588641_0.webp',
    afterImg: '/images/about/S__59588642_0.webp',
    period: '2ヶ月',
    count: '2回目',
    description: 'タンクトップを堂々と着られるように。',
    body: '巻き肩も改善し綺麗なラインが出る服も着られる様に。・2回目、体重比なし',
  },
  {
    id: 5,
    title: 'ブライダル二の腕ケア',
    beforeImg: '/images/about/S__59588650_0.webp',
    afterImg: '/images/about/S__59588651_0.webp',
    period: '2ヶ月',
    count: '6回目',
  ...
  },
  {
    id: 6,
    title: '振袖・二の腕集中ケア',
    beforeImg: '/images/about/S__59588654_0.webp',
    afterImg: '/images/about/S__59588655_0.webp',
    period: '2ヶ月',
    count: '20回以上',
    description: '振袖のときの見た目が気にならなくなりました。',
    body: '振袖の時の見た目が気にならなくなりました。・20回以上、体重比なし',
  },
  {
    id: 7,
    title: '肩甲骨・二の腕まわり改善',
    beforeImg: '/images/about/S__59891722.webp',
    afterImg: '/images/about/S__59891722.webp',
    period: '1.5ヶ月',
    count: '1回目',
    description: '背中から腕まわりがすっきり。',
    body: '体重比なし。二の腕痩せは背中からが必須',
  },
  {
    id: 8,
    title: 'ノースリーブが着たい方のケア',
    beforeImg: '/images/about/833D6852-EF9E-4A8F-A928-46EEC32EF093.webp',
    afterImg: '/images/about/833D6852-EF9E-4A8F-A928-46EEC32EF093.webp',
    period: '2ヶ月',
    count: '1回目',
    description: '夏の服を楽しめるように。',
    body: '思いっきり夏服を楽しめる様に。・1回目、体重比なし',
  },
];
