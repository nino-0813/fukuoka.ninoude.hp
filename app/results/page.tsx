      ...
      <article className="pt-20 pb-16 bg-[#f5f2ed]">
        <header className="py-20 text-center relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <p className="font-serif-jp text-xl text-[#1a1a1a] tracking-[0.3em]">症例写真・施術事例</p>
              ...
              >
                <div className="relative overflow-hidden flex">
                  {study.beforeImg === study.afterImg ? (
                    <div className="w-full relative aspect-[8/5] bg-stone-100">
                      <Image
                        src={study.beforeImg}
                    ...
                    <>
                      <div className="w-1/2 relative aspect-[4/5] bg-stone-100">
                        <Image
                          src={study.beforeImg}
                          alt={`${study.title} 施術前`}
                          fill
                          className={`object-contain ${study.id === 7 ? 'scale-110' : ''}`}
                          sizes="(max-width: 768px) 100vw, 33vw"
                        />
                        <span className="absolute top-4 left-4 bg-black/40 backdrop-blur-sm text-white text-[9px] px-2 py-1 rounded uppercase tracking-widest">
                          Before
                      ...
                      <div className="w-1/2 relative aspect-[4/5] bg-stone-100">
                        <Image
                          ...
                          alt={`${study.title} 施術後`}
                          fill
                          className={`object-contain transition-transform duration-700 group-hover:scale-110 ${study.id === 7 ? 'scale-110' : ''}`}
                          sizes="(max-width: 768px) 100vw, 33vw"
                        />
                ...
                <div className="p-8">
                  ...
                  {study.body && (
                    <p className="mt-3 text-sm text-[#5a5a5a] leading-relaxed whitespace-pre-line">{study.body}</p>
                  )}
                </div>
              </article>
            ))}
